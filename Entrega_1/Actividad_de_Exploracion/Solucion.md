...
Para la gestión de un gimnasio se deben considerar los siguientes conceptos:
...
- **Membresías:** acuerdos que permiten a los clientes acceder al gimnasio durante un periodo determinado. Pueden ser mensuales, trimestrales, semestrales o anuales.
- **Planes y tarifas:** condiciones comerciales asociadas a cada membresía, como precio, duración, beneficios, límites de uso y promociones.
- **Pagos y facturación:** registro de pagos, fechas de vencimiento, métodos de pago, descuentos, saldos pendientes y comprobantes.
- **Tipos de pago:**
- **Servicios:** actividades ofrecidas por el gimnasio, por ejemplo musculación, cardio, clases grupales, valoración física, nutrición y entrenamiento personalizado.
...
- **Clases grupales:** actividades programadas, como yoga, zumba, spinning o entrenamiento funcional, con un instructor, horario y capacidad definidos.
...
- **Rutinas de entrenamiento:** conjuntos de ejercicios asignados a un cliente según sus objetivos, nivel, condición física y disponibilidad.
- **Ejercicios:** actividades que componen una rutina. Se describen mediante el grupo muscular trabajado, las series, las repeticiones, el peso, la duración o el nivel de dificultad.
- **Evaluaciones y progreso físico:** mediciones periódicas como peso, estatura, porcentaje de grasa, masa muscular, resistencia y cumplimiento de objetivos.
...
- **Mantenimiento de equipos:** inspecciones, reparaciones y mantenimientos preventivos necesarios para garantizar la seguridad y el funcionamiento del equipamiento.
